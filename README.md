...
I have completed this project using Postgre SQL. I have written the SQL queries to find out the answer of the question that helped me to analyze the data. In this project, i have answered 15 questions  that really helped me to findout the result that i supposed to find out.
<img width="456" height="90" alt="image" src="https://github.com/user-attachments/assets/a8645a9c-a5ca-4ed6-9a35-c163ca3017af" />
